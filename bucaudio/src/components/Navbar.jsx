				...
				<NavLink to="/home">
					{({ isActive }) => (
						<Button
							...
							px={4}
							w="full">
							<AiFillHome style={{fill:"#F1F1F1", stroke:"#F1F1F1"}} size={20} />
							<span>Home</span>
						</Button>
					)}
				</NavLink>
				<NavLink to="/library">
					{({ isActive }) => (
						<Button
							...
							py={6}
							px={4}>
							<HiViewGrid style={{fill:"#F1F1F1", stroke:"#F1F1F1"}} size={20} />
							<span>Browse</span>
						</Button>
					)}
				</NavLink>
				<NavLink to="/playlists">
					{({ isActive }) => (
						<Button
							...
							py={6}
							px={4}>
							<BsHeadphones style={{fill:"#F1F1F1", stroke:"#F1F1F1"}} size={20} />
							<span>Playlists</span>
						</Button>
					)}
				</NavLink>
				<NavLink to="/favorites">
					{({ isActive }) => (
						<Button
							...
							py={6}
							px={4}>
							<AiFillHeart style={{fill:"#F1F1F1", stroke:"#F1F1F1"}} size={20} />
							<span>Favorites</span>
						</Button>
					)}
				</NavLink>
