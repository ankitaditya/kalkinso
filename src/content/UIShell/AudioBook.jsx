...
const AudioBook = (props) => {
    ...
    const [title, setTitle] = useState('Audio Book');
    ...
    useEffect(() => {
      ...
      if(selectedTool&&selectedTool.name==="audiobook-assistant"&&Object.keys(selectedTool.selectedEntry).length>0&&selectedTool.selectedEntry?.children?.entries?.length>0){
