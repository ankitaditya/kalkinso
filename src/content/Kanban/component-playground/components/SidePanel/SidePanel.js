...
import FileUploaderDragAndDrop from '../CreateTearsheet/FileUploaderDragAndDrop';
import { skills } from '../CreateTearsheet/constants';
...
const SidePanel = (props) => {
  ...
  const [editValues, setEditValues] = useState(props?.data?props.data:{});
  ...
  const updateCards = () => {
    ...
    dispatch(updateTask(editValues._id, editValues));
        ...
        <TextInput
            ...
            <FileUploaderDragAndDrop
              {...{
                ...
                disabled: false,
                tabIndex: 0,
                attachments: editValues?editValues?.attachments:[],
