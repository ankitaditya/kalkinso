...
import { DiagramComponent, SymbolPaletteComponent, Node, DiagramTools, NodeConstraints, ConnectorConstraints, PrintAndExport, UndoRedo, Inject } from "@syncfusion/ej2-react-diagrams";
      ...
      <div className="control-section">
        ...
        <div style={{ display: 'none' }}>
            ...
            if (diagramInstance !== undefined) {
                ...
                let btnZoomIncrement = new DropDownButton({ items: [
