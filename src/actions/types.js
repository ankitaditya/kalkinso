...
export const GET_KIT_URL = 'GET_KIT_URL'
...
export const IS_MULTI = 'IS_MULTI'
...
export const GET_CHAT_SESSIONS = 'GET_CHAT_SESSIONS'
export const GET_CHAT_SESSION = 'GET_CHAT_SESSION'
...
export const SAVE_USER_DEVICE_INFO = 'SAVE_USER_DEVICE_INFO'
